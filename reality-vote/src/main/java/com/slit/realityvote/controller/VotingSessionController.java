...
public class VotingSessionController {
    ...
    @PostMapping
    public String create(@Valid @ModelAttribute("votingSession") VotingSession session,BindingResult result,
      @RequestParam(required = false) Long episodeId,
      @RequestParam(required = false) List<Long> contestantIds,Model model,
